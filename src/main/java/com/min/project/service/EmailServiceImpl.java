...
import com.min.project.service.EmailService;
...
public class EmailServiceImpl implements EmailService {
    ...
    private MimeMessage createMessage(String email)throws Exception{
        ...
        message.setSubject("bonobonoMusic회원가입 이메일 인증");//제목

        String msgg="";
        msgg+= "<div style='margin:100px;'>";
        msgg+= "<h1> 안녕하세요 bonobonoMusic입니다. </h1>";
        msgg+= "<br>";
        ...
        message.setFrom(new InternetAddress("alscjf126@naver.com","Bonobono"));//보내는 사람
